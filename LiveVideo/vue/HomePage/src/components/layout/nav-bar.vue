<template>
  ...
  <div>
    ...
    <el-header  class="animate__animated animate__fadeIn">
      ...
      <div class="user_show">
        <img :alt="item" src="https://p0.meituan.net/dpplatform/e03c1cef70236dd3beb7a12c17d18c3d8912.jpg" width="40" class="user_pic">
        <el-link href="https://element.eleme.io" type="success" class="user_name">name</el-link>
      </div>
      <div class="search_input">
        ...
        <el-button round icon="el-icon-search" circle class="el-search"></el-button>
      </div>
    </el-header>
  </div>
...
export default {
  data () {
    return {
      ...
      user_pic_src:'url(https://p0.meituan.net/dpplatform/e03c1cef70236dd3beb7a12c17d18c3d8912.jpg)'
    }
  }
}
</script>
